...
<head>
	...
	<link rel="stylesheet" type="text/css" href="inputkarya.css">
...
<div class="container_form">
	<div class="title">Form Input Data Karya</div>
	<div class="content">
		<form action="/input_karya" method="POST" enctype="multipart/form-data">
			...
			<div class="user-details">
				...
				<div class="input-inbox">
					...
					<input type="text" name="nama" placeholder="Masukkan Nama Karya">
				</div>
				<div class="input-inbox">
				...
				<div class="input-inbox">
					...
					<input type="text" name="link_karya" placeholder="Masukkan Link Karya">
				</div>
				<div class="">
